...
> **Kanonik dosya: [TODO.md](TODO.md).** Bu, sahibinin brief'inin özgün Türkçe hâlidir;
> İngilizce dosya onun çevirisidir. Çelişki hâlinde İngilizce dosya geçerlidir (D-3).

# Yet Another Idle RPG Fork — Story & Gameplay Expansion

> **Bu dosya kuyruk değil, bağlam.** İçinde checkbox yok ve hiçbir maddesi
> işaretlenmiyor. Brief, verildiği hâliyle bütün olarak duruyor; böylece herkes gerçekte
> ne istendiğini, onun bir özetinden değil kendisinden okuyabiliyor.
>
> İşin kendisi [PROPOSALS.TR.md](PROPOSALS.TR.md) içinde izleniyor; brief orada koda karşı
> ölçülüp numaralı önerilere dönüştürüldü — P-14 bu dosyanın v0.7 bölümü, P-15 ile P-17 de
> sonraki talepler. Sırada ne olduğunu öğrenmek için önerileri, nedenini öğrenmek için
> burayı okuyun.
>
> Bu ayrım önemli, çünkü brief'in bazı varsayımları kodda yok. Bir lockpicking skill'i, bir
> navigation skill'i ve lonca itibarı anıyor; yazıldığı sırada üçü de mevcut değildi.
> Doğrudan buradan çalışmak, verilmiş kararları yeniden türetmek ve ölçülüp düzeltilmiş
> varsayımlara göre davranmak olur. Ölçülmüş plan öneridir; bu, onun arkaplanı.
>
> P-17'ye kadar izlem dışıydı. Artık git'te, çünkü kimsenin göremediği bir brief, kimsenin
> işi karşısında denetleyemediği bir brief demek.
