...
(()=>{
    ...
    woodworking_recipes.components["Short hilt"] = new ComponentRecipe({
        ...
        materials: [
			...
			{material_id: "Processed hickory wood", count: 1, result_id: "Short hickory wood hilt"},
			{material_id: "Alchemical Wood", count: 1, result_id: "Short alchemical wood hilt"},
        ],
        item_type: "Component",
    ...
    woodworking_recipes.components["Medium handle"] = new ComponentRecipe({
        ...
        materials: [
			...
			{material_id: "Processed hickory wood", count: 2, result_id: "Medium hickory wood handle"},
			{material_id: "Alchemical Wood", count: 2, result_id: "Medium alchemical wood handle"},
        ],
        item_type: "Component",
        recipe_skill: "Woodworking",
    });
    woodworking_recipes.components["Long shaft"] = new ComponentRecipe({
        ...
        materials: [
			...
			{material_id: "Processed hickory wood", count: 4, result_id: "Long hickory wood shaft"},
			{material_id: "Alchemical Wood", count: 4, result_id: "Long alchemical wood shaft"},
        ],
        item_type: "Component",
        recipe_skill: "Woodworking",
    });
...
(()=>{
    woodworking_recipes.components["Shield base"] = new ComponentRecipe({
        ...
        materials: [
			...
			{material_id: "Processed hickory wood", count: 6, result_id: "Hickory wood shield base"},
    ...
    woodworking_recipes.components["Shield handle"] = new ComponentRecipe({
        ...
        materials: [
			...
			{material_id: "Processed hickory wood", count: 4, result_id: "Hickory wood shield handle"},
