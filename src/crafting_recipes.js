...
(()=>{
    forging_recipes.components["Short blade"] = new ComponentRecipe({
        ...
        materials: [
            ...
            {material_id: "White iron ingot", count: 2, result_id: "White iron short blade"},
            {material_id: "White steel ingot", count: 2, result_id: "White short blade"},
            {material_id: "Black iron ingot", count: 2, result_id: "Black iron short blade"},
            {material_id: "Black steel ingot", count: 2, result_id: "Black short blade"},
        ],
        item_type: "Component",
    ...
    forging_recipes.components["Long blade"] = new ComponentRecipe({
        ...
        materials: [
            ...
            {material_id: "White iron ingot", count: 3, result_id: "White iron long blade"},
            {material_id: "White steel ingot", count: 3, result_id: "White long blade"},
            {material_id: "Black iron ingot", count: 3, result_id: "Black iron long blade"},
            {material_id: "Black steel ingot", count: 3, result_id: "Black long blade"},
        ],
        item_type: "Component",
        recipe_skill: "Forging",
    });
    forging_recipes.components["Axe head"] = new ComponentRecipe({
        ...
        materials: [
            ...
            {material_id: "White iron ingot", count: 4, result_id: "White iron axe head"},
            {material_id: "White steel ingot", count: 4, result_id: "White axe head"},
            {material_id: "Black iron ingot", count: 4, result_id: "Black iron axe head"},
            {material_id: "Black steel ingot", count: 4, result_id: "Black axe head"},
        ],
        item_type: "Component",
        recipe_skill: "Forging"
    });
    forging_recipes.components["Hammer head"] = new ComponentRecipe({
        ...
        materials: [
            ...
            {material_id: "White iron ingot", count: 4, result_id: "White iron hammer head"},
            {material_id: "White steel ingot", count: 4, result_id: "White hammer head"},
            {material_id: "Black iron ingot", count: 4, result_id: "Black iron hammer head"},
            {material_id: "Black steel ingot", count: 4, result_id: "Black hammer head"},
        ],
        item_type: "Component",
        recipe_skill: "Forging",
    });
    ...
    forging_recipes.components["Short hilt"] = new ComponentRecipe({
        ...
        materials: [
            ...
            {material_id: "White iron ingot", count: 1, result_id: "White iron short handle"},
            {material_id: "White steel ingot", count: 1, result_id: "White short handle"},
            {material_id: "Black iron ingot", count: 1, result_id: "Black iron short handle"},
            {material_id: "Black steel ingot", count: 1, result_id: "Black short handle"},
    ...
    forging_recipes.components["Medium handle"] = new ComponentRecipe({
        ...
        materials: [
            ...
            {material_id: "White iron ingot", count: 2, result_id: "White iron medium handle"},
            {material_id: "White steel ingot", count: 2, result_id: "White medium handle"},
            {material_id: "Black iron ingot", count: 2, result_id: "Black iron medium handle"},
            {material_id: "Black steel ingot", count: 2, result_id: "Black medium handle"},
    ...
    forging_recipes.components["Long shaft"] = new ComponentRecipe({
        ...
        materials: [
            ...
            {material_id: "White iron ingot", count: 4, result_id: "White iron long handle"},
            {material_id: "White steel ingot", count: 4, result_id: "White long handle"},
            {material_id: "Black iron ingot", count: 4, result_id: "Black iron long handle"},
            {material_id: "Black steel ingot", count: 4, result_id: "Black long handle"},
...
(()=>{
    ...
    forging_recipes.components["Shield base"] = new ComponentRecipe({
        ...
        materials: [
            ...
            {material_id: "White iron ingot", count: 5, result_id: "White iron shield base"},
            {material_id: "White steel ingot", count: 5, result_id: "White shield base"},
            {material_id: "Black iron ingot", count: 5, result_id: "Black iron shield base"},
            {material_id: "Black steel ingot", count: 5, result_id: "Black shield base"},
...
(()=>{
    ...
    forging_recipes.components["Helmet exterior"] = new ComponentRecipe({
        ...
        materials: [
            ...
            {material_id: "White plate", count: 3, result_id: "White plate helmet armor"},
            {material_id: "Black iron plate", count: 3, result_id: "Black iron plate helmet armor"},
            {material_id: "Black plate", count: 3, result_id: "Black plate helmet armor"},
            ...
            {material_id: "White chainmail", count: 3, result_id: "White chainmail helmet armor"},
            {material_id: "Black iron chainmail", count: 3, result_id: "Black iron chainmail helmet armor"},
            {material_id: "Black chainmail", count: 3, result_id: "Black chainmail helmet armor"},
    ...
    forging_recipes.components["Chestplate exterior"] = new ComponentRecipe({
        ...
        materials: [
            ...
            {material_id: "White plate", count: 5, result_id: "White plate chestplate armor"},
            {material_id: "Black iron plate", count: 5, result_id: "Black iron plate chestplate armor"},
            {material_id: "Black plate", count: 5, result_id: "Black plate chestplate armor"},
            ...
            {material_id: "White chainmail", count: 5, result_id: "White chainmail chestplate armor"},
            {material_id: "Black iron chainmail", count: 5, result_id: "Black iron chainmail chestplate armor"},
            {material_id: "Black chainmail", count: 5, result_id: "Black chainmail chestplate armor"},
    ...
    forging_recipes.components["Leg armor exterior"] = new ComponentRecipe({
        ...
        materials: [
            ...
            {material_id: "White plate", count: 4, result_id: "White plate greaves"},
            {material_id: "Black iron plate", count: 4, result_id: "Black iron plate greaves"},
            {material_id: "Black plate", count: 4, result_id: "Black plate greaves"},
            ...
            {material_id: "White chainmail", count: 4, result_id: "White chainmail greaves"},
            {material_id: "Black iron chainmail", count: 4, result_id: "Black iron chainmail greaves"},
            {material_id: "Black chainmail", count: 4, result_id: "Black chainmail greaves"},
    ...
    forging_recipes.components["Glove exterior"] = new ComponentRecipe({
        ...
        materials: [
            ...
            {material_id: "White plate", count: 3, result_id: "White plate glove armor"},
            {material_id: "Black iron plate", count: 3, result_id: "Black iron plate glove armor"},
            {material_id: "Black plate", count: 3, result_id: "Black plate glove armor"},
            ...
            {material_id: "White chainmail", count: 3, result_id: "White chainmail glove armor"},
            {material_id: "Black iron chainmail", count: 3, result_id: "Black iron chainmail glove armor"},
            {material_id: "Black chainmail", count: 3, result_id: "Black chainmail glove armor"},
    ...
    forging_recipes.components["Shoes exterior"] = new ComponentRecipe({
        ...
        materials: [
            ...
            {material_id: "White plate", count: 3, result_id: "White plate shoe armor"},
            {material_id: "Black iron plate", count: 3, result_id: "Black iron plate shoe armor"},
            {material_id: "Black plate", count: 3, result_id: "Black plate shoe armor"},
            ...
            {material_id: "White chainmail", count: 3, result_id: "White chainmail shoe armor"},
            {material_id: "Black iron chainmail", count: 3, result_id: "Black iron chainmail shoe armor"},
            {material_id: "Black chainmail", count: 3, result_id: "Black chainmail shoe armor"},
...
(function(){
    ...
    */
    ...
    forging_recipes.items["White iron chainmail"] = new ItemRecipe({
        name: "White iron chainmail",
        recipe_type: "material",
        materials: [{material_id: "White iron ingot", count: 2}],
        result: {result_id: "White iron chainmail", count: 1},
        success_chance: [0.1,1],
        recipe_skill: "Forging",
        recipe_level: [15,25],
    });
    forging_recipes.items["Black iron chainmail"] = new ItemRecipe({
        name: "Black iron chainmail",
        recipe_type: "material",
        materials: [{material_id: "Black iron ingot", count: 2}],
        result: {result_id: "Black iron chainmail", count: 1},
        success_chance: [0.1,1],
        recipe_skill: "Forging",
        recipe_level: [15,25],
    });
    ...
    */
    ...
    forging_recipes.items["White chainmail"] = new ItemRecipe({
        name: "White chainmail",
        recipe_type: "material",
        materials: [{material_id: "White steel ingot", count: 2}],
        result: {result_id: "White chainmail", count: 1},
        success_chance: [0.1,1],
        recipe_skill: "Forging",
        recipe_level: [22,32],
    });
    forging_recipes.items["Black chainmail"] = new ItemRecipe({
        name: "Black chainmail",
        recipe_type: "material",
        materials: [{material_id: "Black steel ingot", count: 2}],
        result: {result_id: "Black chainmail", count: 1},
        success_chance: [0.1,1],
        recipe_skill: "Forging",
        recipe_level: [22,32],
    });
    forging_recipes.items["White plate"] = new ItemRecipe({
        name: "White plate",
        recipe_type: "material",
        materials: [{material_id: "White steel ingot", count: 3}],
        result: {result_id: "White plate", count: 1},
        success_chance: [0.1,1],
        recipe_skill: "Forging",
        recipe_level: [24,34],
    });
    forging_recipes.items["Black plate"] = new ItemRecipe({
        name: "Black plate",
        recipe_type: "material",
        materials: [{material_id: "Black steel ingot", count: 3}],
        result: {result_id: "Black plate", count: 1},
        success_chance: [0.1,1],
        recipe_skill: "Forging",
        recipe_level: [24,34],
    });
    ...
    */
    smelting_recipes.items["White iron ingot"] = new ItemRecipe({
        name: "White iron ingot",
        recipe_type: "material",
        materials: [{material_id: "White iron ore", count: 5}, {material_type: "coal", count: 1}],
        result: {result_id: "White iron ingot", count: 1},
        success_chance: [0.3,1],
        recipe_level: [15,25],
        recipe_skill: "Smelting",
    });
    smelting_recipes.items["Black iron ingot"] = new ItemRecipe({
        name: "Black iron ingot",
        recipe_type: "material",
        materials: [{material_id: "Black iron ore", count: 5}, {material_type: "coal", count: 1}],
        result: {result_id: "Black iron ingot", count: 1},
        success_chance: [0.3,1],
        recipe_level: [15,25],
        recipe_skill: "Smelting",
    });
    ...
    */
    smelting_recipes.items["White steel ingot"] = new ItemRecipe({
        name: "White steel ingot",
        recipe_type: "material",
        materials: [{material_id: "White iron ore", count: 5},
                    {material_id: "Heavy sand", count: 3},
                    {material_type: "coal", count: 2}],
        result: {result_id: "White steel ingot", count: 1},
        success_chance: [0.2,1],
        recipe_level: [25,35],
        recipe_skill: "Smelting",
    });
    smelting_recipes.items["Black steel ingot"] = new ItemRecipe({
        name: "Black steel ingot",
        recipe_type: "material",
        materials: [{material_id: "Black iron ore", count: 5},
                    {material_id: "Heavy sand", count: 3},
                    {material_type: "coal", count: 2}],
        result: {result_id: "Black steel ingot", count: 1},
        success_chance: [0.2,1],
        recipe_level: [25,35],
        recipe_skill: "Smelting",
    });
