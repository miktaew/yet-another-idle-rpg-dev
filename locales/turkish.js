...
const descriptions = {
    ...
    */
    ...
    "activity Lake beach climbing starting": "Yar yüzünden halatla inme pratiği yap",
    ...
    "action rappel waterfall starting": "Şelalenin yanındaki yar yüzünden halatla inmeyi dene",
    ...
    "action rappel waterfall success": "Yavaş ve titiz bir işti, ama yar yüzü boyunca güvenli ve sağlam bir geçit sabitlemeyi başardın. Bu, bundan sonraki inip çıkmaları belirgin biçimde hızlandıracak",
    "action create lake climbing starting": "Halatla iniş çalışma noktası hazırla",
    "action create lake climbing desc": "Buradaki yar yüzü, halatla iniş gibi ileri tırmanma tekniklerini çalışmak için iyi bir yer olur",
    "action create lake climbing during": "Güvenli bir iniş noktası aranıyor",
    "action create lake climbing success": "Bir saat sonra, yarın kenarına yakın sığ bir çıkıntının üstüne biraz halatı güvenle sabitlemeyi başarıyorsun. Bütün yar yüzünden inmeyi denemeden önce burada çalışabilirsin",
