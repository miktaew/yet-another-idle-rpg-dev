...
const names = {
    ...
    */
    ...
    "name Fight off the assailant": "Saldırganı savuştur",
    ...
    "name Gentle mountain slope": "Yumuşak dağ yamacı",
    ...
    "name Riverbank shore": "Nehir kıyısı sahili",
    "name Shack": "Baraka",
...
const descriptions = {
    ...
    */
    ...
    "desc loctype rough 2": "Batak bir sazlık, hayatın için dövüşmek için berbat bir yer",
    "desc loctype rough 3": "Çamur bir yandan seni yerinde sıkı tutarken bir yandan da nasılsa kaydırıyor",
    ...
    "desc location Precarious tree bridge": "Bir bakla domuzu gürültüyü duymuş ve karşı geçidi tutuyor.",
    ...
    "desc location Downstream from the village": "Yengeçlerin cırtlak takırtısı doğru yöne gittiğini söylüyor sana. Nehir kıyısının sahiline yaklaşırken, önce yolunu kesen küçük bir bina boyundaki bir kaya sandığın şeye çarpıyorsun. Ta ki kıpırdamaya başladığını görene kadar...",
    ...
    "desc location Riverbank joined 1": "Dev yengecin kabuğunda yaralayıcı bir çatlak açmayı başarıyorsun; hayvan çılgına dönüp ormana kaçıyor. Bir anlık huzurda çevrene bir göz atıyorsun. Ve nehir kıyısındaki yengeçlerin sayısı bir gösterge sayılırsa, burası duyduğun o kocaman yengeç yuvası olabilir. Buradaki yengeç kalabalığında kıyının nehir kıyısıyla nerede birleştiğini bile ayırt edemiyorsun. Dev yengecin izi kolayca görünüyor, ama küçük yengeçlerin saldırısına uğramadan takip etmek mümkün değil. Yolun üzerinde muhtemelen birkaç grubunu aşman gerekecek",
    ...
    "loc Swampland fields unlock": "Üzerinden kötü bir alamet geçerken, bataklık bir tarlaya uzanan eski bir izin otlar bürümüş kalıntılarını zar zor seçebiliyorsun",
    ...
    "activity Lake beach climbing starting": "Yar yüzünden halatla inmeyi çalış",
    ...
    "activity Forest lake balancing starting": "Su ayaklarının etrafından coşarken şelalenin tepesinde dengede durmayı dene",
    ...
    "activity Waterfall basin meditating unlock": "Şelalenin arkasındaki kaya siperinden taş yengeçleri sürüp bitirdiğinde, kayalardan yansıyan seslerde tuhaf bir dinginlik duygusu hissediyorsun. Yumuşak bir uğultuyla ve sağlam taşla çevrili bu nokta, oturup zihnini odaklamak için kusursuz görünüyor",
    ...
    "noise Adventurer's guild 21": "Birkaç seferimi aldı, ama onları gerçekten gördüm...",
    ...
    "action search for delivery starting": "Kayıp tahıl teslimatı için köyü ara",
    "action search for delivery desc": "Biraz zaman alabilir, ama bir yerde olmak zorunda",
    ...
    "action explore2 desc": "Keçilerden fazlası, değerli bir şeyler olmalı diye bir his taşıyorsun.",
    ...
    "action search for boars starting": "Yaban domuzlarının olduğu açıklık için ormanı ara",
    ...
    "action follow ant trail unlock": "Görevin bitse de çiftliklerden uzakta daha çok karınca bulabilecek gibi görünüyorsun",
    ...
    "action rappel waterfall during": "Yardan halatla inilliyor",
    ...
    "action gaze name": "Nehrin götürdüğü yeri takip et",
    ...
    "name Helmet exterior": "Kask dışı",
    "name Chestplate exterior": "Göğüs zırhı dışı",
    "name Leg armor exterior": "Bacak zırhı dışı",
    "name Glove exterior": "Eldiven dışı",
    "name Shoes exterior": "Ayakkabı dışı",
    "name Axe": "Balta",
    "name Dagger": "Hançer",
    "name Hammer": "Çekiç",
    "name Spear": "Mızrak",
    ...
    "skill effect Persistence": "Düşük dayanıklılık stat çarpanını x{v1} seviyesine yükseltir (aslı x0,5)",
    ...
    "skill effect Haggling": "Tüccar fiyat çarpanını özgün değerin %{v1} kadarına düşürür",
    ...
    "ui reading provided": "Okumak {v1} için şunları sağladı:",
