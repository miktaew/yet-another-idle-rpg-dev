...
const names = {
    ...
    */
    ...
    "name Twist liek a snek": "Yilan gibi kivril",
    ...
    "name White steel chainmail": "Beyaz çelik zincir zırh örgüsü",
    "name Black steel chainmail": "Siyah çelik zincir zırh örgüsü",
    "name Scraps of wolf rat meat": "Kurt sıçanı eti kırpıntıları",
    ...
    "name Basic spare parts": "Temel yedek parça",
...
const descriptions = {
    ...
    */
    ...
    "desc item Alligator skin": "Bir timsahın pürtüklü, pullu ham derisi. Aldatıcı biçimde sağlam ve esnek, ama dokunması rahatsız edici ve soğuğu tutmakta berbat",
    ...
    "desc item Silica Sand": "Alındığı su kütlesinde yaşayıp ölen sayısız kuşağın kalıntılarıyla güçlenmiş kum",
    ...
    "desc item Carp": "Daha güçlü biçimlerinden birine henüz büyümemiş, dolayısıyla eti hâlâ yağlı ve dolgun",
    ...
    "desc item Simple dream catcher": "Bir söğüt kasnağa gerilmiş kiriş ağı. Nasıl işlediğini ya da ne yaptığını bilmiyorsun, ama seni daha güvende hissettiriyor. Tasarımı bir rüyada geldi",
    ...
    "desc item White steel chainmail": "Birbirine geçirilmiş düzinelerce küçük beyaz çelik halka, çok ağır. Giyilebilir bir biçimden çok uzak; zırha dönüştürmek hâlâ bir sürü emek ve odak isteyecek",
    "desc item Black steel chainmail": "Birbirine geçirilmiş düzinelerce küçük siyah çelik halka. Giyilebilir bir biçimden çok uzak; zırha dönüştürmek hâlâ bir sürü emek ve odak isteyecek",
    "desc item Scraps of wolf rat meat": "Nereden geldiklerini ve taşıdıkları bütün hastalıkları görmezden gelirsen aslında yenebilir görünüyorlar. Yeter ki önce pişirmeyi unutma",
    ...
    "desc item Pork roast": "Ete bol bol ot yoğurulmuş; sonuç, insanın ağzını sulandıran bir kokuya sahip doyurucu bir yemek",
    ...
    "desc item Fish steak": "Düzgünce filetolanmış ve pişirilmiş. Bütün yemekten çok daha iyi bir deneyim",
    "desc item Apple pie": "Hoş bir turta; kabuğu enfes ve ağzına kadar nefis elma parçalarıyla dolu",
    "desc item Carrot cake": "Kuru üzümlü ve cevizli, üstüne krem peynirli krema sürülmüş, ıslak bir havuçlu kek",
    "desc item Cider": "Hafif tatlı, mayhoş ve ferahlatıcı bir kokuya sahip, mayalanmış elma suyu",
    ...
    "desc enemy Frog": "Kaslı bacakları ve bir ulukurdu bütün yutabilecek kadar geniş bir ağzı olan kocaman bir yaratık",
